...
public class ServerComponentTest extends AbstractComponentTest {
    ...
    public void testUriSchemeComponent() throws URISyntaxException {
        ...
        markupDocBuilder = new ServerComponent(context).apply(markupDocBuilder, ServerComponent.parameters(swagger.getServers(), OverviewDocument.SECTION_TITLE_LEVEL));
