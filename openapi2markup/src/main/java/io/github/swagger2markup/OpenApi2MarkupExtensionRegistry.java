 ...
 */
public interface OpenApi2MarkupExtensionRegistry {
    /**
     * OpenApiModelExtension extension point can be used to preprocess the OpenAPI model.
     *
     * @return registered extensions extending OpenAPIModelExtension extension point
     */
    List<OpenApiModelExtension> getOpenApiModelExtensions();
