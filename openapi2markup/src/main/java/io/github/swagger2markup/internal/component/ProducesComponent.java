...
public class ProducesComponent extends MarkupComponent<ProducesComponent.Parameters> {
    ...
    public ProducesComponent(OpenApi2MarkupConverter.Context context) {
        super(context);
    }

    public static ProducesComponent.Parameters parameters(Set<String> consumes,
                                                          int titleLevel) {
    ...
    public static class Parameters {
        ...
        public Parameters(Set<String> produces, int titleLevel) {
