...
public class PathOperationComponent extends MarkupComponent<PathOperationComponent.Parameters> {
    ...
    public PathOperationComponent(OpenApi2MarkupConverter.Context context,
    ...
    private void buildDescriptionSection(MarkupDocBuilder markupDocBuilder, PathOperation operation) {
        ...
        if (isNotBlank(description)) {
            descriptionBuilder.paragraph(markupDescription(config.getOpenApiMarkupLanguage(), markupDocBuilder, description));
        }
    ...
    private void buildConsumesSection(MarkupDocBuilder markupDocBuilder, PathOperation operation) {
        Set<String> consumes = DefaultCodegen.getConsumesInfo(context.getOpenApi(), operation.getOperation());
    ...
    private void buildProducesSection(MarkupDocBuilder markupDocBuilder, PathOperation operation) {
        Set<String> produces = DefaultCodegen.getProducesInfo(context.getOpenApi(), operation.getOperation());
    ...
    /**
     * Builds the security section of a OpenAPI Operation.
     *
     * @param operation the OpenAPI Operation
     */
    ...
    /**
     * Builds the example section of a OpenAPI Operation.
     *
     * @param operation the OpenAPI Operation
     */
