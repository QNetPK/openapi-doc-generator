...
public class ConsumesComponent extends MarkupComponent<ConsumesComponent.Parameters> {
    ...
    public ConsumesComponent(OpenApi2MarkupConverter.Context context) {
        super(context);
    }

    public static ConsumesComponent.Parameters parameters(Set<String> consumes,
                                                          int titleLevel) {
    ...
    public static class Parameters {
        ...
        public Parameters(Set<String> consumes,
                          int titleLevel) {
