...
This project is a Markup document builder (AsciiDoc, Markdown and ConfluenceWiki). The primary goal of this project is to simplify the creation of Markup documents. The builder is used by https://github.com/QNetPK/openapi-doc-generator[openapi-doc-generator].

The project requires at least JDK 8.

=== Usage
=== Adding MarkupDocBuilder to your project
The project is published in Sonatype and Maven Central.
