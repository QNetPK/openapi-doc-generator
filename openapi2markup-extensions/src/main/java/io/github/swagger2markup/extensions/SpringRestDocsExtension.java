...
public final class SpringRestDocsExtension extends PathsDocumentExtension {
    ...
    private static final Map<String, String> DEFAULT_SNIPPETS = new LinkedHashMap<>() {{
    ...
    public void init(OpenApi2MarkupConverter.Context globalContext) {
        ...
        if (snippetBaseUriProperty.isPresent()) {
            ...
            if (globalContext.getOpenApiLocation() == null) {
                ...
                snippetBaseUri = URIUtils.uriParent(globalContext.getOpenApiLocation());
            }
        }
